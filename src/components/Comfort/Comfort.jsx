...
const Comfort = ({updateProgress}) => {
  ...
  return (
    <div className="flex flex-col justify-start items-center min-h-screen mx-2 mt-10">
      ...
      <button className={`bg-black text-white rounded-md p-2 px-10 my-4 mt-10   ${selectedBox !== null ? '' : 'pointer-events-none opacity-50'}`} disabled={!selectedBox} onClick={handleContinue} >
       Continue
      </button>
    </div>
  );
