  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen">
      ...
      <div className="flex flex-row justify-center mt-12">
        <div className="w-1/4 relative p-4 border border-gray-500 rounded-md mr-2 flex">
          {/* "Most Popular" tag */}
        ...
        <div className="w-1/4 flex items-center p-4 border border-gray-500 rounded-md ml-2">
          <div>
